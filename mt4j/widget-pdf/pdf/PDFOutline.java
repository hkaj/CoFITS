...
import utc.tatinpic.model.pdf.Bookmark;
...
public class PDFOutline extends MTRectangle
{
	...
	public PDFOutline(MTApplication applet, float x, float y, float width, float height, PDFModel pdf)
	{
		...
		MTTextArea txtTitle = new MTTextArea(applet, x + 40, y + 10, width - 50, 40, FontManager.getInstance().createFont(applet, "calibri", 25, MTColor.SILVER, true));
		...
		PImage iconCancel = applet.loadImage(PropertyManager.getInstance().getProperty(PropertyManager.IMAGE_DIR) + "cancel.png");
